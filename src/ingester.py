...
def extract_text_from_pdf(file_path: str) -> str:
    ...
    Páginas são separadas por \\n\\n para que o chunker semântico
    detecte corretamente os limites de parágrafo.
    """
    path = Path(file_path)
    ...
    try:
        ...
        # Páginas separadas por \n\n → o chunker semântico consegue dividir
        text = "\n\n".join(pages)
...
def extract_text_from_pdf_by_page(file_path: str) -> List[Dict]:
    path = Path(file_path)
